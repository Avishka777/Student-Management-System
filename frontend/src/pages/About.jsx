    ...
    <Box sx={{ maxWidth: '1200px', margin: 'auto', marginBottom: '40px'  }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', margin: 'auto' }}>
        ...
        <Typography variant="body1" sx={{ color: '#6B7280' }}>
          The STARK UNIVERSITY was founded in 1999 and is a University Grants Commission (UGC) recognized Institute that stands today as a symbol of excellence in private tertiary education. Welcome to Phoenix Institute, a leading institution dedicated to fostering excellence in education and innovation. At Phoenix, we believe in empowering students with knowledge and skills that prepare them for the challenges of the modern world. With a dynamic curriculum designed to meet the evolving needs of industries and society, we offer a diverse range of programs across various disciplines, including technology, business, arts, and sciences. Our experienced faculty members are committed to providing personalized guidance and support to help students realize their full potential. Through state-of-the-art facilities and interactive learning experiences, we strive to create a vibrant learning community where creativity thrives and ideas flourish. Join us at Phoenix Institute and embark on a journey of discovery, growth, and success.
        </Typography>
      </Box>
